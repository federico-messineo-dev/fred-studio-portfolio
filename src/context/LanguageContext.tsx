...
export const translations: Translations = {
  ...
  'services.s1.f3': { it: 'Mobile First', en: 'Mobile First' },
  'services.s1.f4': { it: 'CMS Integrato', en: 'Integrated CMS' },
  ...
  'contact.form.placeholder.email': { it: '[ inserisci email... ]', en: '[ enter email... ]' },
